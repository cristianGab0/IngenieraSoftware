...
//     private long pasajero;
    ...
    public VueloPasajero(VueloPasajeroId id, Pasajero pasajero, Vuelo vuelo, String equipaje, BigDecimal pesoEquipaje, String sillon, String estadoBoleto, String claseVuelo, BigDecimal precioVuelo) {
       this.id = id;
       this.pasajero = pasajero;
       this.vuelo = vuelo;
    ...
    @Column(name="sillon", length=3)
    public String getSillon() {
        return this.sillon;
    }
    
    public void setSillon(String sillon) {
        this.sillon = sillon;
    }
    ...
    @Column(name="precio_vuelo", precision=7)
